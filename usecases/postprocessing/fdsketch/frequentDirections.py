...
from fdsketch.matrixSketcherBase import MatrixSketcherBase
import sys
import argparse
...
class FrequentDirections(MatrixSketcherBase):
    ...
    def append(self, vector):
        ...
        try:
            ...
            # check in the sketch
            if any(isnan(self._sketch)):
                print('Sketch contains NaN')
            if any(isinf(self._sketch)):
                print('Sketch contains Inf')
            raise ValueError()
