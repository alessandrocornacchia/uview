...
func set_Frontend_PoolClient_Definitions(b *golang.NamespaceBuilder) {
	b.Define("frontend.client.ot", func(n *golang.Namespace) (any, error) {
		// Auto-generated by the golang plugin gogen/namespacebuilder.go
		var client ot.Frontend_OTServerWrapperInterface
		if err := n.Get("frontend.http_client", &client); err != nil {
			return nil, err
		}
		...
		return ot.New_Frontend_OTClientWrapper(n.Context(), client, coll_client)
	})
