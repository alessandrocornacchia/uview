...
func makeOriginalSpec(spec wiring.WiringSpec) ([]string, error) {
	...
	// TODO: this also now gives problems, related to go versioning 1.22 vs 1.22.1 explicit... we don not need it anyway,
	// as we use external tools to generate the workload
	// wlgen := workload.Generator[workloadgen.SimpleWorkload](spec, "wlgen", frontend_service)
	// cntrs = append(cntrs, wlgen)

	// TODO: understand why this gives me problems related to permissions
