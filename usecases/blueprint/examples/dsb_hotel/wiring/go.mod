...
require github.com/blueprint-uservices/blueprint/blueprint v0.0.1

require github.com/blueprint-uservices/blueprint/plugins v0.0.1

require (
	github.com/blueprint-uservices/blueprint/examples/dsb_hotel/tests v0.0.0-20240619221802-d064c5861c1e
	github.com/blueprint-uservices/blueprint/examples/dsb_hotel/workflow v0.0.1
	github.com/blueprint-uservices/blueprint/examples/dsb_hotel/workload v0.0.0-20240619221802-d064c5861c1e
)
